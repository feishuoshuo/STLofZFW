...
template <class Value, class HashFcn = zfwstl::hash<Value>,
          class EqualKey = zfwstl::equal_to<Value>>
class unordered_set {
  typedef hashtable<Value, Value, HashFcn, zfwstl::identity<Value>, EqualKey>
      ht;
...
public:
  ...
  unordered_set(InputIter f, InputIter l) : rep(100, hasher(), key_equal()) {
    rep.insert_unique(f, l);
  }
  template <class InputIter>
  unordered_set(InputIter f, InputIter l, size_type n)
      : rep(n, hasher(), key_equal()) {
    rep.insert_unique(f, l);
  }
  template <class InputIter>
  unordered_set(InputIter f, InputIter l, size_type n, const hasher &hf)
      : rep(n, hf, key_equal()) {
    rep.insert_unique(f, l);
  }
  template <class InputIter>
